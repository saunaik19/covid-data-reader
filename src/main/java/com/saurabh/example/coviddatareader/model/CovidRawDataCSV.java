...
public class CovidRawDataCSV {
    ...
    public CovidRawDataCSV() {
    }


    public CovidRawDataCSV(String FIPS, String admin2, String province_State, String country_Region, String last_Update, String lat, String long_, String confirmed, String deaths, String recovered, String active, String combined_Key, String incidence_Rate, String case_Fatality_Ratio) {
        this.FIPS = FIPS;
        Admin2 = admin2;
